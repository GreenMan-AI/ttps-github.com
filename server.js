...
app.use((req, res, next) => {
  ...
  const allowed = [
    'https://soundpulse-2wgs.onrender.com',
...
app.use((req, res, next) => {
  ...
  res.setHeader('Content-Security-Policy',
    ...
    "connect-src 'self' https://*.cloudinary.com https://api.cloudinary.com https://res.cloudinary.com https://soundpulse-2wgs.onrender.com https://greenman-ai.onrender.com https://api.qrserver.com; " +
...
if (!MONGO_URI) {
  ...
  console.error('   Pievieno MONGODB_URI savienojuma virkni kā vides mainīgo.');
  process.exit(1);
}
...
// Speciāls maršruts privātuma politikai (Googlei)
