...
export default function AdminScreen() {
  ...
  const uploadTrack = async () => {
    if (!file) return Alert.alert(t.error, 'Izvēlies failu!');
    setUploading(true);
    try {
        ...
        {tab === 'upload' && (
          <View>
            ...
            <TouchableOpacity style={styles.pickBtn} onPress={pickFile}>
              <Ionicons name="folder-open" size={20} color="#00cfff" />
            ...
            {tracks.map((tr: any) => (
              <View key={tr._id} style={styles.trackRow}>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.trackArtist}>{tr.plays || 0} atskaņojumi</Text>
                </View>
