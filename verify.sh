...
check "uploadBgImage (fona bildes augšupielāde)" "grep -c 'function uploadBgImage' public/app.js" "1"
...
check_min "Fona bildes endpoint" "grep -c \"'/api/content/background'\" server.js" "1"
